...
/* Script.js v22 (Week 3 Results + Overall Log)
...
const week2 = {
  ...
  B: [
    ...
    // ✅ Week 2 updated: Xihuhuri 0 : 2 Junior Pirates (home Junior Pirates)
...
function bestHighlightLatestPlayed() {
  ...
  played.sort((x, y) =>
    ...
    ((y.homeGoals + y.awayGoals) - (x.homeGoals + y.awayGoals))
  );
  const m = played[0];
