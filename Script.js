...
const week9 = {
  A: [
    { home: "FC Wondrous", away: "Crusaders FC", homeGoals: 3, awayGoals: 3 },
    { home: "Fast Eleven FC", away: "Morning Stars FC", homeGoals: 1, awayGoals: 3 },
    { home: "Eastern Rangers FC", away: "Royal Tigers FC", homeGoals: 2, awayGoals: 2 },
    { home: "Highlanders FC", away: "Movers FC", homeGoals: 4, awayGoals: 1 }
  ],
  B: [
    { home: "Liverpool FC", away: "City Pillars FC", homeGoals: 5, awayGoals: 0 },
    { home: "Xihuhuri FC", away: "Junior Pirates FC", homeGoals: 0, awayGoals: 0 },
    { home: "Labamba FC", away: "Bhubhezi FC", homeGoals: 1, awayGoals: 1 },
    { home: "Welverdiend Masters FC", away: "Real Rangers FC", homeGoals: 3, awayGoals: 2 },
    { home: "Xihuhuri FC", away: "Welverdiend Masters FC", homeGoals: 3, awayGoals: 4, note: "Outstanding game" }
  ]
};
...
const week11 = {
  A: [
    ...
    { home: "Eastern Rangers FC", away: "Movers FC", homeGoals: null, awayGoals: null, note: "Postponed" },
  ...
  B: [
    ...
    { home: "Bhubhezi FC", away: "City Pillars FC", homeGoals: 1, awayGoals: 2, note: "Outstanding game" }
  ]
};
...
const fixtures = [
  { date: "Saturday, 11 April 2026", time: "16:00", match: "Xihuhuri FC vs Welverdiend Masters FC", venue: "Xihuhuri FC", status: "FT • 3-4", stream: "B" },

  { date: "Sunday, 12 April 2026", time: "16:00", match: "FC Wondrous vs Crusaders FC", venue: "FC Wondrous", status: "FT • 3-3", stream: "A" },
  { date: "Sunday, 12 April 2026", time: "16:00", match: "Fast Eleven FC vs Morning Stars FC", venue: "Fast Eleven FC", status: "FT • 1-3", stream: "A" },
  { date: "Sunday, 12 April 2026", time: "16:00", match: "Eastern Rangers FC vs Royal Tigers FC", venue: "Eastern Rangers FC", status: "FT • 2-2", stream: "A" },
  { date: "Sunday, 12 April 2026", time: "16:00", match: "Highlanders FC vs Movers FC", venue: "Highlanders FC", status: "FT • 4-1", stream: "A" },

  { date: "Sunday, 12 April 2026", time: "16:00", match: "Liverpool FC vs City Pillars FC", venue: "Liverpool FC", status: "FT • 5-0", stream: "B" },
  { date: "Sunday, 12 April 2026", time: "16:00", match: "Xihuhuri FC vs Junior Pirates FC", venue: "Xihuhuri FC", status: "FT • 0-0", stream: "B" },
  ...
  { date: "Sunday, 19 April 2026", time: "16:00", match: "Bhubhezi FC vs City Pillars FC", venue: "Bhubhezi FC", status: "FT • 1-2", stream: "B" },
  ...
  { date: "Monday, 27 April 2026", time: "16:00", match: "Crusaders FC vs Highlanders FC", venue: "Crusaders FC", status: "FT • 1-1", stream: "A" },
  { date: "Monday, 27 April 2026", time: "16:00", match: "Eastern Rangers FC vs Movers FC", venue: "Eastern Rangers FC", status: "Postponed", stream: "A" },
  { date: "Monday, 27 April 2026", time: "16:00", match: "Morning Stars FC vs FC Wondrous", venue: "Morning Stars FC", status: "FT • 4-0", stream: "A" },
  { date: "Monday, 27 April 2026", time: "16:00", match: "Royal Tigers FC vs Fast Eleven FC", venue: "Royal Tigers FC", status: "FT • 3-0", stream: "A" },

  { date: "Monday, 27 April 2026", time: "16:00", match: "Bhubhezi FC vs Liverpool FC", venue: "Bhubhezi FC", status: "FT • 1-4", stream: "B" },
  { date: "Monday, 27 April 2026", time: "16:00", match: "Real Rangers FC vs Xihuhuri FC", venue: "Real Rangers FC", status: "Pending", stream: "B" },
  { date: "Monday, 27 April 2026", time: "16:00", match: "Welverdiend Masters FC vs City Pillars FC", venue: "Welverdiend Masters FC", status: "FT • 2-2", stream: "B" },
  { date: "Monday, 27 April 2026", time: "16:00", match: "Junior Pirates FC vs Labamba FC", venue: "Junior Pirates FC", status: "FT • 3-4", stream: "B" }
];
...
function renderResults(id, data) {
  ...
  if (!data.length) {
    ...
    li.textContent = "No confirmed result yet.";
    el.appendChild(li);
    return;
  }
...
function setLeaders() {
  ...
  if ($("leaderA")) $("leaderA").textContent = `A: ${tableA[0].team} (${tableA[0].Pts} pts)`;
  if ($("leaderB")) $("leaderB").textContent = `B: ${tableB[0].team} (${tableB[0].Pts} pts)`;
}
...
function setupFixtureFilters() {
  ...
  function applyFilters() {
    ...
    const filtered = fixtures.filter(f => {
      const streamMatch = !activeStream || f.stream === activeStream;
      const textMatch =
        !term ||
...
function setupResultSearch() {
  ...
  const resultMap = {
    ...
    resultsListA11: week11.A, resultsListB11: week11.B
  };
